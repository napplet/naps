...
security. Everything else -- relay access, storage, identity queries,
inter-napplet communication, message protocols -- is a NAP.
...
| [NAP-INC](https://github.com/napplet/naps/pull/5) | `window.napplet.inc` | Inter-napplet communication | Draft |
