...
| [NAP-COMMON](https://github.com/napplet/naps/pull/67) | `common` |  | `identity` `relay` | NIP-19 helpers, profile lookup, follows, and common social actions (follow, unfollow, react, report) | Draft |
